# Module 3 Project, File 2 (Amber Speer)
"""Roll a pair of six-sided dice 6,000,000 times."""
import random

# face total frequency counters
frequency2 = 0
frequency3 = 0
frequency4 = 0
frequency5 = 0
...
print (f'Craps: {craps/rolls:.2f}')
print (f'Win: {win/rolls:.2f}')
